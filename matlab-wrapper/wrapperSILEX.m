...
classdef wrapperSILEX < handle
    properties
        ...
        mpiExecute='mpirun';
        %files for running
        resultFile='results/cavity8_with_porous_air_flexible_structure_CB_results.mat';%'results/cavity7_with_porous_results.mat';  %mat-file provided by python
        pythonMakeMesh={'Main_make_mesh_porous_air_cavity8.py','Main_make_mesh_porous_struct_cavity8.py'};%'Main_make_mesh_porous_cavity8.py';%'Main_make_mesh_porous_cavity7.py'; %'Main_make_mesh_porous_cavity7.py';
        pythonCompute={'Main_xfem_fluid_porous_flex_struc_CB_reduction_OFFLINE_8.py','Main_xfem_fluid_porous_flex_struc_CB_reduction_ONLINE_8.py'};%'Main_classic_fluid_porous7.py'; %'Main_classic_fluid_porous7.py';
        %MPI options
        mpiOptNbCores='-np';
