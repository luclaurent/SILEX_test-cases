...
#############################################################################
print 'SILEX CODE - calcul du MUCD avec des tetraedres a 10 noeuds'
#############################################################################
...
MeshFileName='MUCD-tet10'

# Output result file: define the name of the result file (*.msh)
ResultsFileName='Results_MUCD-tet10'
...
elements,Idnodes=silex_lib_gmsh.ReadGmshElements(MeshFileName+'.msh',11,1)
