...
results_file='results/cavity7_CB_with_porous_air_v4'
...
if (Flag_frf_analysis==1):
    ...
    for i in range(nb_freq_step_per_proc):
        ...
        sol = mumps.spsolve(  scipy.sparse.coo_matrix(K-(omega**2)*M,dtype='c16')  , F , comm=mycomm )
