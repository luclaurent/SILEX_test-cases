...
// control volume
Point(31) = {lx5-h5/2,     ly5-h5/2  , lz5-h5/2, h/1.5};
Point(32) = {lx5-h5/2,    ly5-h5/2  , lz5+h5/2, h/1.5};
Point(33) = {lx5+h5/2,     ly5-h5/2  , lz5-h5/2, h/1.5};
Point(34) = {lx5+h5/2,    ly5-h5/2  , lz5+h5/2, h/1.5};
Point(35) = {lx5-h5/2,     ly5+h5/2  , lz5-h5/2, h/1.5};
Point(36) = {lx5-h5/2,    ly5+h5/2  , lz5+h5/2, h/1.5};
Point(37) = {lx5+h5/2,     ly5+h5/2  , lz5-h5/2, h/1.5};
Point(38) = {lx5+h5/2,    ly5+h5/2  , lz5+h5/2, h/1.5};
Line(75) = {33, 37};
Line(76) = {37, 35};
Line(77) = {35, 31};
Line(78) = {31, 33};
...
Point(21) = {lx3+r4,     ly3  , lz4 , (h+h)/2};
Point(22) = {lx3+l4-r4,     ly3  , lz4, (h+h)/2};
