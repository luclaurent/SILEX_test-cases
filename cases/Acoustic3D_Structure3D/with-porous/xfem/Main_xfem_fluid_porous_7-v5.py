...
# mpirun -np 20  python3 Main_xfem_fluid_porous_7-v5.py
#
...
results_file='results/cavity7_with_porous_air_flexible_structure'
...
if (Flag_frf_analysis==1):
    ...
    if rank==0:
        ...
        f.close()
        print('nb of total dofs: ',len(SolvedDofF)+len(SolvedDofA)+len(SolvedDofP)+len(SolvedDofS),)
