def WriteGmshGeoFileAndMakeTheMesh(filename,parameters):
    ...
    f.write('// Porous, surfaces and volume\n')
    ...
    f.write('Surface Loop(187) = {155, 153, 143, 145, 147, 149, 163, 161, 159, 172, 174, 184, 182, 180, 178, 176, 186, 167, 165, 169};\n')
    ...
    f.write('// Porous\n')
    f.write('Physical Volume(2) = {157}; // porous volume\n')
    f.write('Physical Surface(4) = {141}; // porous external surface\n')
    #f.write('Physical Surface(4) = {151}; // porous external surface\n')
    f.write('Physical Surface(3) = {155}; // [porous]-[air cavity] : interface surface\n')
    f.close()
    import os
...
def ComputeFRF(parameters):
    ...
    mesh_file='results/cavityporous3'
    results_file='results/cavityporous3'
    import ComputePorousCavity3
    ComputePorousCavity3.WriteGmshGeoFileAndMakeTheMesh(mesh_file,[angle])
    ...
    ro_sol = 30.0 #this should be (1-porosity)*rho_s
    ...
    #SolvedDofP=np.setdiff1d(range(fluid_ndof2),range(fluid_ndof2))
