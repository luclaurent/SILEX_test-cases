...
Surface Loop(187) = {155, 153, 143, 145, 147, 149, 163, 161, 159, 172, 174, 184, 182, 180, 178, 176, 186, 167, 165, 169};
Volume(1) = {99, 187};
...
// Porous
Physical Volume(2) = {157}; // porous volume
Physical Surface(4) = {153, 143, 145, 147, 149, 151, 141}; // porous external surface
Physical Surface(3) = {155}; // [porous]-[air cavity] : interface surface
