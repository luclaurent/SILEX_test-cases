...
f.write('\n')
f.write('\n')
f.write('Line(140) = {6, 39};\n')
f.write('Line(141) = {7, 60};\n')
f.write('Line(142) = {14, 56};\n')
f.write('Line(143) = {13, 52};\n')
f.write('Line(144) = {12, 48};\n')
f.write('Line(145) = {5, 40};\n')
f.write('Line(146) = {8, 44};\n')
f.write('Line Loop(147) = {21, 145, -133, -140};\n')
f.write('Plane Surface(148) = {147};\n')
f.write('Line Loop(149) = {20, 140, -139, -141};\n')
f.write('Plane Surface(150) = {149};\n')
f.write('Line Loop(151) = {19, 141, -138, -142};\n')
f.write('Plane Surface(152) = {151};\n')
f.write('Line Loop(153) = {18, 142, -137, -143};\n')
f.write('Plane Surface(154) = {153};\n')
f.write('Line Loop(155) = {17, 143, -136, -144};\n')
f.write('Plane Surface(156) = {155};\n')
f.write('Line Loop(157) = {16, 144, -135, -146};\n')
f.write('Plane Surface(158) = {157};\n')
f.write('Line Loop(159) = {15, 146, -134, -145};\n')
...
f.write('\n')
f.write('Surface Loop(163) = {132, 148, 160, 158, 156, 154, 152, 150, 131};\n')
...
f.write('\n')
f.write('Physical Surface(4) = {148, 150, 152, 156, 158, 160, 132, 154};// porous external surface\n')
f.close()
import os
os.system('zsh -i -c "gmsh -3 %s.geo"' % filename)
