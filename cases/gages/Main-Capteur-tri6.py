...
#import silex_lib_tri6_fortran as silex_lib_elt
...
#############################################################################
print("SILEX CODE - calcul d'un capteur de force avec des tri6")
#############################################################################
...
make_capteur_mesh.WriteGmshGeoTri6('capteur-tri6',[0.0,0.0,5.0,1.0])

# Output result file: define the name of the result file (*.msh)
#ResultsFileName='Results_capteur_tri6_fortran'
ResultsFileName='Results_capteur_tri6_python'
