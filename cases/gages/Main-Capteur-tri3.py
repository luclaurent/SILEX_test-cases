...
make_capteur_mesh.WriteGmshGeoTri3('capteur-tri3',[0.0,0.0,5.0,1.0])
...
# force vector
Couple=120.0*96.0
sigma_max=3.0*Couple/(2.0*20.0**2)
F=silex_lib_elt.forceonline(nodes,elementsS3,[sigma_max,-120.0/40.0,-sigma_max,-120.0/40.0],[192.0,0.0,192.0,40.0])
