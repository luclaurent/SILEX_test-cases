...
mesh_file='geom/simple_cavity_tet4'
results_file='results_orig/simple_cavity_tet4'
...
fluid_nodes    = silex_lib_gmsh.ReadGmshNodes(str(cwd / (mesh_file+'_fluid.msh')),3)
fluid_elements1,IdNodes1 = silex_lib_gmsh.ReadGmshElements(str(cwd / (mesh_file+'_fluid.msh')),4,1) # air, cavity 
fluid_elements5,IdNodes5 = silex_lib_gmsh.ReadGmshElements(str(cwd / (mesh_file+'_fluid.msh')),4,5) # air, ONLY controlled volume
...
if (flag_write_gmsh_results==1) and (rank==0):
    silex_lib_gmsh.WriteResults(str(cwd/(results_file+'_air_cavity_Mesh1')),fluid_nodes1,fluid_elements1,4)
...
# Load structure mesh
##############################################################
struc_nodes        = silex_lib_gmsh.ReadGmshNodes(str(cwd /(mesh_file+'_struc.msh')),3)
struc_elements,tmp = silex_lib_gmsh.ReadGmshElements(str(cwd /(mesh_file+'_struc.msh')),2,6)
struc_boun,tmp     = silex_lib_gmsh.ReadGmshElements(str(cwd /(mesh_file+'_struc.msh')),1,7)
...
if (flag_write_gmsh_results==1) and (rank==0):
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_struc_mesh_surface_6')),struc_nodes,struc_elements,2)
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_struc_boun_mesh_line_7')),struc_nodes,struc_boun,1)
...
if (flag_write_gmsh_results==1) and (rank==0):
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_LS_signed_distance')),fluid_nodes1,fluid_elements1,4,[[[LevelSet],'nodal',1,'Level set']])
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_LS_tangent_level_set')),fluid_nodes1,fluid_elements1,4,[[[LevelSetTangent],'nodal',1,'Tangent level set']])
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_LS_distance')),fluid_nodes1,fluid_elements1,4,[[[distance],'nodal',1,'Distance']])
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_LS_tangent_mesh')),tangent_nodes,tangent_mesh,2)
...
if (flag_write_gmsh_results==1) and (rank==0):
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_LSenriched_elements')),fluid_nodes1,fluid_elements1[LSEnrichedElements],4)
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_enriched_elements')),fluid_nodes1,fluid_elements1[EnrichedElements],4)
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_edge_enriched_elements')),fluid_nodes1,fluid_elements1[EdgeEnrichedElements],4)
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_edge_enriched_elements_in_all_mesh')),fluid_nodes1,fluid_elements1[EdgeEnrichedElementsInAllMesh],4)
    silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_heaviside_enriched_elements')),fluid_nodes1,fluid_elements1[HeavisideEnrichedElements],4)
...
silex_lib_gmsh.WriteResults2(str(cwd /(results_file+'_CutEdgeMEsh_LS')),NodesCutEdgeMesh,EltCutEdgeMEsh,4,[[[LSnewnodes],'nodal',1,'Level set'],[[LStgtnewnodes],'nodal',1,'Tangent level set']])
