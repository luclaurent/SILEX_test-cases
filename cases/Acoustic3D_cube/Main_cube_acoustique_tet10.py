...
mesh_file='cube_acou_tet10'
results_file='cube_acou_tet10'
...
fluid_elements,tmp = silex_lib_gmsh.ReadGmshElements(mesh_file+'.msh',11,1) # air, cavity + controlled volume
fluid_elements5,IdNodes5 = silex_lib_gmsh.ReadGmshElements(mesh_file+'.msh',11,5) # air, ONLY controlled volume
fluid_elements_S6,IdNodesS6 = silex_lib_gmsh.ReadGmshElements(mesh_file+'.msh',9,6) # external surface
...
silex_lib_gmsh.WriteResults(results_file+'Mesh',fluid_nodes,fluid_elements,11)
silex_lib_gmsh.WriteResults(results_file+'Mesh_surface',fluid_nodes,fluid_elements_S6,9)
silex_lib_gmsh.WriteResults(results_file+'Mesh_control_volum',fluid_nodes,fluid_elements5,11)
...
tic = time.process_time()
print(silex_lib_acou_tet10.globalacousticmatrices.__doc__)
IIf,JJf,Vffk,Vffm=silex_lib_acou_tet10.globalacousticmatrices(fluid_elements,fluid_nodes,celerity,rho)
...
print(silex_lib_acou_tet10.computecomplexquadratiquepressure.__doc__)
##################################################################
...
if (Flag_frf_analysis==1):
    ...
    for freq in scipy.linspace(freq_ini,freq_end,nb_freq_step):
        ...
        frf.append(silex_lib_acou_tet10.computecomplexquadratiquepressure(fluid_elements5,fluid_nodes,press))
