...
classdef wrapperSILEXcurve_rotate < handle
    properties
        ...
        mpiExecute='mpirun';
        %files for running
        resultFile='results_curve_rotate/xfem_3_results.mat';
        pythonMakeMesh={};
        pythonCompute={'Main_xfem_3_curve_rotate_complex.py'};%{'Main_xfem_3_curve_complex_save.py'};%{'Main_xfem_3_mod_complex.py'};
        %MPI options
        mpiOptNbCores='-np';
    ...
    methods
        %constructor
        function obj=wrapperSILEXcurve_rotate(paraVal,nbProc)
            dt=datetime;
            fprintf('============================\n');
