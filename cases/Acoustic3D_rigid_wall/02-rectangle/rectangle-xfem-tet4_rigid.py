...
def RunPb(
    ...
    if Flag_frf_analysis == 1:
        ...
        if rank == 0:
            ...
            data ={"freq": AllfreqSorted, "mag": AllfrfSorted, "nbnodes": fluid_nnodes, "nelem": fluid_nelem1}
            ...
            # save on mat file
            scipy.io.savemat(
                results_file + "_results.mat", mdict={"data": data}
            )
            scipy.io.savemat(
                results_file_ini + "results.mat", mdict={"data": data}
            )
            #####################
            #####################
            return Allfrfsave
