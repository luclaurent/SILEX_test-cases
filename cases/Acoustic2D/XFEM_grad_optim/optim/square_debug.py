...
def RunPb(freqMin,freqMax,nbStep,nbProc,rank,comm,paraVal,caseDefine):
    ...
    mesh_file='geom/xfem3_square_debug'
    ...
    if (Flag_frf_analysis==1):
        ...
        for freq in freqCompute:
            ...
            sol=mumps.spsolve(  scipy.sparse.coo_matrix(pbFreq,dtype='complex')  , F+0.j , comm=mycomm )
            ...
            for itP in range(0,nbPara):
                ...
                Dsol_Dtheta_RAW = mumps.spsolve(  scipy.sparse.coo_matrix(K-(omega**2)*M,dtype='complex')  , tmpG , comm=mycomm )
