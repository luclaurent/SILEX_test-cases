...
with open(cwd / "results/xfem_2_62000_results.frf", "rb") as f:
    frf_1 = pickle.load(f)

with open(cwd / "results/xfem_2_62001_results.frf", "rb") as f:
    frf_2 = pickle.load(f)

with open(cwd / "results/xfem_2_62002_results.frf", "rb") as f:
    frf_3 = pickle.load(f)
...
Dp_Dtheta_diff = (frf_3[1] - frf_1[1]) / (0.62002 - 0.62000)
...
for id_freq in range(len(frf_1[0])):
    ...
    dpress_node_diff = (press_node_3 - press_node_1) / (0.62002 - 0.62000)
