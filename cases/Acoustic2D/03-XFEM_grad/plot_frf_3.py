...
##frf_3=pickle.load(f)
##f.close()
with open(cwd / "results" / "xfem_3_6200_results.frf", "rb") as f:
    frf_1 = pickle.load(f)

with open(cwd / "results" / "xfem_3_6201_results.frf", "rb") as f:
    frf_2 = pickle.load(f)

with open(cwd / "results" / "xfem_3_6202_results.frf", "rb") as f:
    frf_3 = pickle.load(f)
