...
mesh_file = "results/xfem2"
results_file = "results/xfem_2_"
...
freq_ini = 100.0
freq_end = 150.0
nb_freq_step_per_proc = 10  # 50 pour 8 proc.
...
file_extension = str(x_pos_struc)[0:5]
results_file = results_file + file_extension

x_pos_struc = x_pos_struc / 100000
...
if Flag_frf_analysis == 1:
    ...
    for i in range(nb_freq_step_per_proc):
        ...
        Dsol_Dtheta = scipy.sparse.linalg.spsolve(K - (omega**2) * M, tmp)
