...
classdef wrapperSILEXcurve < handle
    properties
        ...
        mpiExecute='mpirun';
        %files for running
        resultFile='results_curve/xfem_3_results.mat';
        pythonMakeMesh={};
        pythonCompute={'Main_xfem_3_curve_complex_save.py'};%{'Main_xfem_3_curve_complex_save.py'};%{'Main_xfem_3_mod_complex.py'};
        %MPI options
        mpiOptNbCores='-np';
    ...
    methods
        %constructor
        function obj=wrapperSILEXcurve(paraVal,nbProc)
            dt=datetime;
            fprintf('============================\n');
