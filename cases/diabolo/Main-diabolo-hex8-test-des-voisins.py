...
MeshFileName='diabolo-test-voisins'

# Output result file: define the name of the result file (*.msh)
ResultsFileName='Results_diabolo_test_voisins'
...
elementsS1,IdnodeS1=silex_lib_gmsh.ReadGmshElements(MeshFileName+'.msh',3,1) # bas
elementsS2,IdnodeS2=silex_lib_gmsh.ReadGmshElements(MeshFileName+'.msh',3,2) # haut
...
F = silex_lib_elt.forceonsurface(nodes,elementsS2,10.0,[0.0,1.0,0.0])
...
Ik,Jk,Vk,Mk=silex_lib_elt.stiffnessmatrix(nodes,elements,[Young,nu,rho])
