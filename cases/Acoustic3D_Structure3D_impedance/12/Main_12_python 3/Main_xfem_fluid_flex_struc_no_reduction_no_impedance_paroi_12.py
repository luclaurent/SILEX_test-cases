...
results_file='results/cavity12_no_impedance_air_flexible_structure'
...
if (Flag_frf_analysis==1):
    ...
    for i in range(nb_freq_step_per_proc):
        ...
        press1 = scipy.zeros((fluid_ndof1),dtype=float)
        press1[SolvedDofF]=sol[list(range(len(SolvedDofF)))]

        enrichment=scipy.zeros((fluid_nnodes),dtype=float)
