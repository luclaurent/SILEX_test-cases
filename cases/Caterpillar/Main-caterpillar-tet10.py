...
#############################################################################
print("SILEX CODE - calcul d'une piece caterpillar avec des tet10")
#############################################################################
...
MeshFileName='piece_caterpillar-tet10'

# Output result file: define the name of the result file (*.msh)
ResultsFileName='Results_caterpillar_tet10'
...
elementsS4,IdnodeS4=silex_lib_gmsh.ReadGmshElements(MeshFileName+'.msh',9,4)
...
##silex_lib_gmsh.WriteResults(ResultsFileName+'surf5',nodes,elementsS5,9)
...
R=maroutine.turn_dof(IdnodeS4,nodes,[0.0,0.0])

# compute external forces from pressure
press = 435000.0/(130.0*scipy.pi*200.0) #MPa
