...
h_struc=0.65
for x_pos_struc_ini in [8200,8201,8202]:
    ...
    LevelSetTangent_gradient=scipy.zeros(fluid_nnodes)
    ...
    #EnrichedElements=scipy.setdiff1d(EnrichedElements,EdgeEnrichedElements)
