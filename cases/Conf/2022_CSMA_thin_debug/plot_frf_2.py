...
f=open('xfem_2_8200_results.frf','rb')
frf_1=pickle.load(f)
f.close()

f=open('xfem_2_8201_results.frf','rb')
frf_2=pickle.load(f)
f.close()

f=open('xfem_2_8202_results.frf','rb')
frf_3=pickle.load(f)
f.close()
...
pl.figure(1)
pl.plot(frf_1[0],10*log10(frf_1[1]/prefsquare),'k-',label='0.6200', linewidth=1)
pl.plot(frf_2[0],10*log10(frf_2[1]/prefsquare),'g-',label='0.6201', linewidth=1)
pl.plot(frf_3[0],10*log10(frf_3[1]/prefsquare),'b-',label='0.6202', linewidth=1)
