...
#results_file_tet10          =Path(__file__).parent / 'cube_xfem_sloshing_with_stiffener_tet10_aachen_eigenmodes_h40'

#mesh_file_fluid_tet4        =Path(__file__).parent / 'cube_xfem_sloshing_Fluid_and_Tank_tet4'
#results_file_tet4           =Path(__file__).parent / 'cube_xfem_sloshing_with_stiffener_tet4_aachen_eigenmodes_h40'
...
results_file_tet10_classic  =Path(__file__).parent / 'cube_sloshing_with_stiffener_tet10_aachen_eigenmodes_h30_e0o005_d1'
#
#mesh_file_tet4_classic      =Path(__file__).parent / 'cube_sloshing_with_stiffener_tet4'
#results_file_tet4_classic   =Path(__file__).parent / 'cube_sloshing_with_stiffener_tet4_aachen_eigenmodes_h40'
...
#[meanQI, maxQI, meanforce, maxforce]=silex_lib_compute_sloshing.sloshing_rigid_baffle_tet4_xfem(dataPb,dataFluid,mesh_file_fluid_tet4,mesh_file_stiffener,results_file_tet4)
#[meanQI, maxQI, meanforce, maxforce]=silex_lib_compute_sloshing.sloshing_rigid_baffle_tet10_xfem(dataPb,dataFluid,mesh_file_fluid_tet10,mesh_file_stiffener,results_file_tet10)
