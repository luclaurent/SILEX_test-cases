...
mesh_file_fluid_tet10       =Path(__file__).parent / 'cube_xfem_sloshing_Fluid_and_Tank_one_param_tet10'
mesh_file_stiffener         =Path(__file__).parent / 'cube_xfem_sloshing_Stiffener_one_param_DKT'
