...
dataStructure['thickness'] = 5.0e+1
...
mesh_file_stiffener         =Path(__file__).parent / 'cube_xfem_sloshing_Stiffener_flexible_DKT'

results_file_tet10_rigid    =Path(__file__).parent / 'cube_xfem_rigid_tet10'
results_file_tet10_flexible =Path(__file__).parent / 'cube_xfem_flexible_tet10'

mesh_file_tet10_classic     =Path(__file__).parent / 'cube_classic_sloshing_rigid_tet10'
results_file_tet10_classic  =Path(__file__).parent / 'cube_classic_rigid_tet10'
...
silex_lib_cube_tank_gmsh_geometry.classic_fluid_and_tank(lx,ly,lz,lx_baffle,lx_baffle_shift_up,lx_baffle_shift_down,lz_baffle,0.001,h_fluid_elts,2,mesh_file_tet10_classic)


silex_lib_compute_sloshing.sloshing_flexible_baffle_tet10_xfem(dataPb,dataFluid,dataStructure,mesh_file_fluid_tet10,mesh_file_stiffener,results_file_tet10_flexible)
#silex_lib_compute_sloshing.sloshing_rigid_baffle_tet10_xfem(dataPb,dataFluid,mesh_file_fluid_tet10,mesh_file_stiffener,results_file_tet10_rigid)
