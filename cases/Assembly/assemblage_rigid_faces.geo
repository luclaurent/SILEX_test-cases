...
Physical Surface(201) = {194, 200, 198, 210, 196};
Physical Surface(202) = {2905, 2998, 2967, 3246, 3122}; 
Physical Surface(203) = {4245, 4152, 4183, 4431, 4307}; 
Physical Surface(204) = {5330, 5516, 5268, 5237, 5392};
...
Physical Surface(101) = {164, 166, 168, 162, 202};
Physical Surface(102) = {3680, 3499, 3618, 3716, 3592};
Physical Surface(103) = {4901, 4994, 5144, 5118, 5051};
Physical Surface(104) = {5862, 5924, 6048, 6012, 5981};
