...
##direction = np.array([1,0,1]) # force in direction +x +z
...
K2_i,K2_j,K2_v = silex_lib_elt.ktan_dd(nodes,elementV11,np.zeros(ndof,dtype='float'),flag2,param2)
...
Knninv_Kns=np.zeros((len(Dofs_n),len(Dofs_s)))
