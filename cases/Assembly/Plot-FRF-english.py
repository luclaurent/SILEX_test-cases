...
#pylab.plot(frf_no_pre_stress_no_damping[0],20*scipy.log10(frf_no_pre_stress_no_damping[1]/RefDisp),'k--',label='no damping, no pre-stress', linewidth=2)
pylab.plot(frf_no_pre_stress_with_fractional_damping[0],20*scipy.log10(frf_no_pre_stress_with_fractional_damping[1]/RefDisp),'k-',label='with damping, no pre-stress', linewidth=2)
...
pylab.plot(frf_with_pre_stress_1000_with_damping[0],20*scipy.log10(frf_with_pre_stress_1000_with_damping[1]/RefDisp),'b-',label='with damping, pre-stress 1000 N', linewidth=2)
pylab.plot(frf_with_pre_stress_2000_with_damping[0],20*scipy.log10(frf_with_pre_stress_2000_with_damping[1]/RefDisp),'g-',label='with damping, pre-stress 2000 N', linewidth=2)
pylab.plot(frf_with_pre_stress_3000_with_damping[0],20*scipy.log10(frf_with_pre_stress_3000_with_damping[1]/RefDisp),'y-',label='with damping, pre-stress 3000 N', linewidth=2)
pylab.plot(frf_with_pre_stress_4000_with_damping[0],20*scipy.log10(frf_with_pre_stress_4000_with_damping[1]/RefDisp),'r-',label='with damping, pre-stress 4000 N', linewidth=2)
#pylab.plot(frf_with_pre_stress_5000_with_damping[0],20*scipy.log10(frf_with_pre_stress_5000_with_damping[1]/RefDisp),'r-',label='with damping, pre-stress 5000 N', linewidth=2)
...
pylab.figure(2)
pylab.plot(frf_no_pre_stress_no_damping[0],20*scipy.log10(frf_no_pre_stress_no_damping[1]/RefDisp),'b--',label='no damping, no pre-stress', linewidth=2)
pylab.plot(frf_no_pre_stress_with_fractional_damping[0],20*scipy.log10(frf_no_pre_stress_with_fractional_damping[1]/RefDisp),'r-',label='fractional derivative damping, no pre-stress', linewidth=2)
#pl.axis([10.0, 200.0, 20, 90])
pylab.xlabel('Frequency [Hz]')
pylab.ylabel('Relative displacement, point P [dB]')
pylab.grid('on')
...
pylab.figure(3)
pylab.plot(frf_no_pre_stress_no_damping[0],20*scipy.log10(frf_no_pre_stress_no_damping[1]/RefDisp),'b--',label='no damping, no pre-stress, reference', linewidth=2)
pylab.plot(frf_rigid_faces_no_pre_stress_no_damping[0],20*scipy.log10(frf_rigid_faces_no_pre_stress_no_damping[1]/RefDisp),'r-',label='no damping, no pre-stress, rigid faces', linewidth=2)
#pl.axis([10.0, 200.0, 20, 90])
pylab.xlabel('Frequency [Hz]')
pylab.ylabel('Relative displacement, point P [dB]')
pylab.grid('on')
...
pylab.figure(4)
pylab.plot(frf_rigid_faces_no_pre_stress_no_damping[0],20*scipy.log10(frf_rigid_faces_no_pre_stress_no_damping[1]/RefDisp),'k-',label='no damping, no pre-stress, rigid faces', linewidth=2)
pylab.plot(frf_beam3_no_pre_stress_no_damping_10modes[0],20*scipy.log10(frf_beam3_no_pre_stress_no_damping_10modes[1]/RefDisp),'b--',label='no damping, C.-B. reduced links, 10 modes (1472 Hz)', linewidth=2)
pylab.plot(frf_beam3_no_pre_stress_no_damping_50modes[0],20*scipy.log10(frf_beam3_no_pre_stress_no_damping_50modes[1]/RefDisp),'r--',label='no damping, C.-B. reduced links, 50 modes (2572 Hz)', linewidth=2)
pylab.plot(frf_beam3_no_pre_stress_no_damping_100modes[0],20*scipy.log10(frf_beam3_no_pre_stress_no_damping_100modes[1]/RefDisp),'y--',label='no damping, C.-B. reduced links, 100 modes (3355 Hz)', linewidth=2)
#pylab.plot(frf_beam3_no_pre_stress_no_damping_500modes[0],20*scipy.log10(frf_beam3_no_pre_stress_no_damping_500modes[1]/RefDisp),'r--',label='no damping, C.-B. reduced links, 500 modes (6409 Hz)', linewidth=2)
