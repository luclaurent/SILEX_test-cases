...
K=scipy.sparse.construct.bmat( [ [fluid_damping*K_diag_mm,None,None],[None,fluid_damping*Khat_pp,None],[None,-Cnp,Knn] ] )
M=scipy.sparse.construct.bmat( [ [M_diag_mm,Mhat_mp,None],[Mhat_mp.T,Mhat_pp,Cnp.T],[None,None,Mnn] ] )
