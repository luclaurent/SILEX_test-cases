...
Psi_FA=scipy.array(Psi_FA.todense())
...
K_pk_1 = scipy.dot(scipy.array(eigen_vectors_F.T*KFF[SolvedDofF,:][:,SolvedDofF]),PsiTilde_Fk)
K_pk_2 = scipy.dot(scipy.array(eigen_vectors_F.T*KAF[SolvedDofF,:][:,SolvedDofA]),PsiHat_Ak)
K_pk = K_pk_1+K_pk_2
...
M_pk_1 = scipy.dot(scipy.array(eigen_vectors_F.T*MFF[SolvedDofF,:][:,SolvedDofF]),PsiTilde_Fk)
M_pk_2 = scipy.dot(scipy.array(eigen_vectors_F.T*MAF[SolvedDofF,:][:,SolvedDofA]),PsiHat_Ak)
M_pk = M_pk_1+M_pk_2
