...
f=open('classic/results/classic_results_no_damping.frf','rb')
...
f=open('xfem/results/xfem_struc_CB_projection_fluid_damping_38F-24S_results.frf','rb')
xfem_struc_CB_38F_24S=pickle.load(f)
f.close()

f=open('xfem/results/xfem_struc_CB_projection_fluid_damping_102F-32S_results.frf','rb')
xfem_struc_CB_102F_32S=pickle.load(f)
f.close()

f=open('xfem/results/xfem_struc_CB_projection_fluid_damping_250F-44S_results.frf','rb')
xfem_struc_CB_250F_44S=pickle.load(f)
f.close()

f=open('xfem/results/xfem_struc_CB2_projection_fluid_damping_250F-44S-20A_results.frf','rb')
xfem_CB2=pickle.load(f)
f.close()

f=open('xfem/results/xfem_struc_CB3_250F-44S-900A_results.frf','rb')
xfem_CB3=pickle.load(f)
f.close()

#f=open('xfem/results/xfem_struc_CB4_250F-44S-100A_results.frf','rb')
#f=open('xfem/results/xfem_struc_CB4_250F-500S-1000A_results.frf','rb')
#f=open('xfem/results/xfem_struc_CB4_102F-32S-64A_results.frf','rb')
#f=open('xfem/results/xfem_struc_CB4_250F-44S-88A_results.frf','rb')
f=open('xfem/results/xfem_struc_CB4_250F-44S-46A_results.frf','rb')
xfem_CB4_46=pickle.load(f)
f.close()

f=open('xfem/results/xfem_struc_CB4_250F-44S-88A_results.frf','rb')
xfem_CB4_88=pickle.load(f)
f.close()

f=open('xfem/results/xfem_struc_CB4_250F-88S-176A_results.frf','rb')
xfem_CB4_176=pickle.load(f)
f.close()

f=open('xfem/results/xfem_struc_CB4_250F-88S-352A_results.frf','rb')
xfem_CB4_352=pickle.load(f)
f.close()
...
pl.plot(xfem_struc_projection_fluid_damping[0],10*log10(xfem_struc_projection_fluid_damping[1]/prefsquare),'y-',label='Xfem, struc. proj. damping', linewidth=2)
pl.plot(xfem_struc_CB_38F_24S[0],10*log10(xfem_struc_CB_38F_24S[1]/prefsquare),'r-',label='Xfem, CB 38F 24S', linewidth=2)
pl.plot(xfem_struc_CB_102F_32S[0],10*log10(xfem_struc_CB_102F_32S[1]/prefsquare),'y-',label='Xfem, CB 102F 32S', linewidth=2)
pl.plot(xfem_struc_CB_250F_44S[0],10*log10(xfem_struc_CB_250F_44S[1]/prefsquare),'b-',label='Xfem, CB 250F 44S', linewidth=2)
#pl.plot(xfem_CB2[0],10*log10(xfem_CB2[1]/prefsquare),'r-',label='Xfem, CB 2', linewidth=2)
#pl.plot(xfem_CB3[0],10*log10(xfem_CB3[1]/prefsquare),'k-',label='Xfem, CB 3', linewidth=2)
#pl.plot(xfem_CB4_46[0],10*log10(xfem_CB4_46[1]/prefsquare),'k-',label='Xfem, CB 4, 46', linewidth=2)
#pl.plot(xfem_CB4_88[0],10*log10(xfem_CB4_88[1]/prefsquare),'r-',label='Xfem, CB 4, 88', linewidth=2)
#pl.plot(xfem_CB4_176[0],10*log10(xfem_CB4_176[1]/prefsquare),'g-',label='Xfem, CB 4, 176', linewidth=2)
#pl.plot(xfem_CB4_352[0],10*log10(xfem_CB4_352[1]/prefsquare),'g-',label='Xfem, CB 4, 352', linewidth=2)
