...
MeshFileName='treillis-croix-tri3'

# Output result file: define the name of the result file (*.msh)
ResultsFileName='Results-5-croix-tri3'
...
# define fixed dof
IdNodesFixed_x=scipy.array([1,4,53,57])
IdNodesFixed_y=scipy.array([1,4,53,57])

# force vector
#F=silex_lib_elt.forceonline(nodes,elementsS2,[0.0,-10.0,0.0,-10.0],[2.0,0.3,2.8,0.3])
