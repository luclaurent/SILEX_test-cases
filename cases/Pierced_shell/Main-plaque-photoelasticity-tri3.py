...
MeshFileName='plaque-trouee-photoelasticity-tri3'

# Output result file: define the name of the result file (*.msh)
ResultsFileName='Results_plaque-trouee-photoelasticity-tri3'
...
s1_s2_0_to_2pi=2.0*np.pi*(s1_s2-mini)/maxi
...
isochromatics=0.5*(np.cos(s1_s2_0_to_2pi*nb_isocromatics)+1)
