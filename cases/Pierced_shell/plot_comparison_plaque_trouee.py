import scipy
import pylab
h_tri3 = np.array([15.0,10.0,5.0,2.0,1.0,0.5,0.3,0.2])
error_tri3 = np.array([0.129858538818,
                     0.0960520190949,
                     0.0510693127416,
                     0.0197007950193,
                     0.00993261608396,
...
nbnodes_tri3=np.array([110,237,934,5973,23778,95245,264832,595775])
sig_yy_smooth_tri3=np.array([30.1,34,39,41.9,42.7,43.3,43.6,43.6])

#nbnodes_tet4=np.array([537,2567,20941,40883])
h_tet4 = np.array([10.0,5.0,2.0,1.0])
error_tet4 = np.array([0.097111090569,0.0534728316945,0.0208490158849,0.0104672015608])
sig_yy_smooth_tet4=np.array([38.4,40.1,43.3,43.8])

#nbnodes_tet10=np.array([3145,16635,])
h_tet10 = np.array([10.0,5.0,2.0])
error_tet10 = np.array([0.0313282600215,0.0121070771312,0.0039289195679])
sig_yy_smooth_tet10=np.array([41.5,42.4,43.3])

h_cub8 = np.array([10.0,5.0,2.0,1.0])
error_cub8 = np.array([0.0533895629703,0.0273552686629,0.010942725697,0.00545002522546])
sig_yy_smooth_cub8=np.array([40.4,42,43,43.4])

h_tri6= np.array([15,10,5,2,1,0.5])
error_tri6 = np.array([0.0593104600664,0.0390222956975,0.014349672345,0.0039735526227,0.00153020602994,0.000630073223845])
sig_yy_smooth_tri6 = np.array([33.67,36.75964292,39.81847943,42.42787186,43.26260978,43.47422746])

h_quad4 = np.array([15.0,10.0,5.0,2.0,1.0,0.5,0.2])*2.0
error_quad4 = np.array([0.130252453372,0.0931474281295,0.0511647892748,0.0209694187995,0.0104544696045,0.00520176420919,0.00207165684466])
sig_yy_smooth_quad4=np.array([31.53351031,36.23343943,39.98988512,42.23628186,42.98234604,43.35536588,43.57927504])
