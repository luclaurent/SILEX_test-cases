...
po_por = 0.94 # ok
sg_por = 40000.0 # ok
lambda_por = 0.000056 # ok
lambda_prime_por = 0.00011 # ok
...
fluid_elements1,IdNodes1 = silex_lib_gmsh.ReadGmshElements(mesh_file+'.msh',4,1) # air
fluid_elements2,IdNodes2 = silex_lib_gmsh.ReadGmshElements(mesh_file+'.msh',4,2) # porous
fluid_elements_S3,IdNodesS3 = silex_lib_gmsh.ReadGmshElements(mesh_file+'.msh',2,3)
fluid_elements_S4,IdNodesS4 = silex_lib_gmsh.ReadGmshElements(mesh_file+'.msh',2,4)
...
IdNodesFixed_porous_uf_y=IdNodesS6
IdNodesFixed_porous_uf_z=IdNodesS5
...
#new_nodes,new_elements=silex_lib_extra.renumberingmesh(fluid_nodes,fluid_elements1,len(scipy.unique(fluid_elements1)))
#silex_lib_gmsh.WriteResults(results_file+'test1',fluid_nodes1,fluid_elements1,4)
#silex_lib_gmsh.WriteResults(results_file+'test2',fluid_nodes2,fluid_elements2,4)
#silex_lib_gmsh.WriteResults(results_file+'test3',fluid_nodes,fluid_elements_S3,2)
...
UF = np.zeros(fluid_ndof1+fluid_ndof2,dtype=float)
UF[0]=3.1250E-05
...
##                                         [None,MPP[SolvedDofP,:][:,SolvedDofP]] ] )
        ...
        frf.append(silex_lib_xfem_acou_tet4.computecomplexquadratiquepressure(fluid_elements1,fluid_nodes1,press1))
