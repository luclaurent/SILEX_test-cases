...
pylab.figure(1)
pylab.plot(frf_tet10_no_damping[0],np.log10(frf_tet10_no_damping[1]),'k-',label='no damping, tet10', linewidth=2)
pylab.plot(frf_tet4_no_damping[0],np.log10(frf_tet4_no_damping[1]),'b-',label='no damping, tet4', linewidth=2)
