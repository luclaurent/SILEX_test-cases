...
import silex_lib_tet10_fortran as silex_lib_elt
#import silex_lib_tet10_python as silex_lib_elt
...
frequencies=scipy.linspace(1,2000,200)
...
silex_lib_gmsh.WriteResults2(ResultsFileName+'_structure_modes',nodes,elements,11,[[eigen_vector_S_list,'nodal',3,'modes']])
...
for i in range(len(frequencies)):
    ...
    frf.append(scipy.sqrt(Q[(221-1)*3]**2+Q[(221-1)*3+1]**2+Q[(221-1)*3+2]**2))
...
silex_lib_gmsh.WriteResults2(ResultsFileName+'_disp_frf',nodes,elements,11,[[disp_save,'nodal',3,'displacement']])
